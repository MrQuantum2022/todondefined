      ...
      <div className="relative flex my-5 flex-col items-center justify-between">
        ...
        <div className="relative flex my-5  flex-col items-center justify-start">
          ...
          <div className="  flex flex-col text-center">
            ...
            <h2 className=" ">Assistant Professor</h2>
            <h2 className="text-sm w-72 lg:text-xs"><br></br>Dr. Ashutosh Singh is a seasoned researcher in the field of Computer Science, having completed his Ph.D. from I.E.T, Lucknow (AKTU, Lucknow).
